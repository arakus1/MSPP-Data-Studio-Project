...
#creating the map
census_map <- bmore_census_data_MERGED_FINAL %>% 
  st_transform(4326) %>% 
  leaflet() %>% 
...
#plotting the unemployment rate layer 
  ...
  addLayersControl(
    overlayGroups = c("Black Population Share", "Unemployment Rate"),
    options = layersControlOptions(collapsed = FALSE)
  ) %>% 
  showGroup(c("Black Population Share")) %>% 
...
#creating the legend for black population
  addLegend(
    ...
    title = "Black Population Share<br>by Census Tract (2014-2018)",
...
htmlwidgets::saveWidget(census_map, "census_map.html", selfcontained = TRUE)
...
**Need to do: 
MAPPING 
2. create heat maps: tract level 
  -percentage of pop as black 
  -income distribution  
...
REGRESSIONS
4. merge with crime data 
5. run basic regressions 

...
Graph Attempt 1 - ok
```{r}
counts <- table(bmore_property_crime_2014_2018$Description)
barplot(counts, main="Distribution of Crime", horiz=TRUE)

```
**Need to do: 
GRAPH
1. refine bar graph showing the distribution of crime types 
